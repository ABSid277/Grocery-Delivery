        ...
        <footer className="bg-app-green text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            {footerData.brand.socials.map((social, i)=>(
                                <a key={i} href={social.link} className="size-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                    ...
                    {/* Columns 2 & 3: Dynamic Category Navigation Sections */}
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {footerData.contact.map((item, i)=>{
                                ...
                                return (
                                    <li key={i} className="flex gap-3 text-sm text-white/70 items-center">
                                        <Icon className="size-4 text-white shrink-0"/> {item.text}
                                    </li>
                                )
                            })}
                        </ul>
