...
const Banner = () => {
  ...
  return (
    <div>
        {bannerVisible && (
            <div className='bg-linear-to-r bg-gradient-to-r from-app-green via-emerald-800 to-app-green text-white text-xs sm:text-sm relative overflow-hidden'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-center gap-6'>
                    
                    {/* Free Delivery Promo */}
                    <div className='flex items-center justify-center gap-2'>
                        <TruckIcon className='size-4 shrink-0'/> {/* Fixed shrink-8 typo */}
                        <span className='font-medium'>Free delivery on orders above $20</span>
                    </div>
                    
                    {/* Daily Delivery Promo */}
