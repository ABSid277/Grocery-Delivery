         ...
         <div onClick={resetForm} className='fixed inset-0 z-50 flex-center p-4'>
            ...
            <div className="space-y-4">
              <div>
                ...
                5">Label</label>
                <input type="text" placeholder="Home, Work, etc." required className="w-full px-4 py-2.5 text-sm rounded-x1 border
                ...
                <input type="text" required className="w-full px-4 py-2.5 text-sm rounded-x1 border border-app-border focus:border-app-green outline-none"
                value={form.address}
