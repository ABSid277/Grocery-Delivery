    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              ...
              {hasFilters && (
                <button className="w-full py-2 text-sm text-app-error hover:bg-red-50 rounded-lg
                transition-colors font-medium" onClick={clearFilters}>Clear All Filters</button>
              )}
        </div>
    )
}
