...
// FIXED: Added the missing ProductCard import (adjust path if your project structure is different)
...
const PopularProducts = () => {
    ...
    }, []); // FIXED: Added empty dependency array to prevent an infinite rendering loop
