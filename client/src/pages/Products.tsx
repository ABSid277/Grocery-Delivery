        ...
        <div className="min-h-screen bg-app-cream">
          ...
          {mobileFiltersOpen && (
            <>
              ...
              <div className="fixed bottom-0 left-0 right-0 bg-white z-50 rounded-t-2xl max-h-[80vh] overflow-y-auto pb-6 animate-slide-in-up">
                <div className="flex items-center justify-between p-4 border-b border-app-border mb-4">
